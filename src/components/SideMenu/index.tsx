...
const SideMenu: React.FC<IProps> = ({ currentPage }) => {
  ...
  return (
    <Container>
      <CardMenu title="Resumo" icon={grid} isActive={isActive('Resumo')} />
      <CardMenu
        title="Oportunidades"
        icon={tags}
        isActive={isActive('Oportunidades')}
      />
      <CardMenu title="Agenda" icon={calendar} isActive={isActive('Agenda')} />
      <CardMenu title="Veículos" icon={taxi} isActive={isActive('Veículos')} />
      <CardMenu
        title="Publicação"
        icon={rocket}
        isActive={isActive('Publicação')}
      />
      <CardMenu title="Contatos" icon={user} isActive={isActive('Contatos')} />
      <CardMenu
        title="Analytics"
        icon={chart}
